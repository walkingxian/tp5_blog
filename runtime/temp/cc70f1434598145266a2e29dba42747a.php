<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"E:\phpstudy\WWW\blog\public/../application/index\view\index\index.html";i:1508673200;s:63:"E:\phpstudy\WWW\blog\public/../application/index\view\base.html";i:1508660252;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<article>
    <div class="_head">
        ...
        <span>作者: </span>
        <span><?php echo $vo['arc_author']; ?></span>
        •
        <!--pubdate表⽰示发布⽇日期-->
        <time pubdate="pubdate" datetime="<?php echo date('Y年m月d日',$vo['sendtime']); ?>">
           <?php echo date('Y年m月d日',$vo['sendtime']); ?>
        </time>
        •
        <span>分类: </span>
    ...
    <div class="_digest">
        <img  src="<?php echo APP_ROOT . $vo['path']; ?>" class="img-responsive"/>
